    ...
    return(
        <div className="info_section" >
           {cardArray.map((infoo, i)=>(
            <Card key={i}>
            <span className="image">{infoo.title} </span>
            <p>{infoo.dsc} </p>
           </Card>
           ))}
        </div>
